    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-12 col-sm-12 mb-12">
          <form id="signupForm" method="post" action="ekle" novalidate="novalidate">
            @csrf
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="lastname" type="text" name="urun_adi" placeholder="Ürün Adını Giriniz...">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" id="email" type="text" name="fiyatı" placeholder="Ürün Fiyatı">
            </div>
            <div class="form-group">
